...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="relative overflow-hidden transition duration-500 ease-in-out transform hover:scale-105 w-32 h-40 md:w-48 md:h-60 lg:w-64 lg:h-80 2xl:w-80 2xl:h-100 group rounded-lg">
      <img
        src={project.image}
        alt={project.name}
      ...
      <div className="absolute bottom-0 left-0 w-full p-4 transition-transform duration-500 ease-in-out transform translate-y-full group-hover:translate-y-0 z-30 text-xl">
